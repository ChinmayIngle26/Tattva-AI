// =============================================
// TATTV.AI – Complete Mock Data Store
// =============================================
...
export const BLOGS = [
  ...
  {
    slug: 'tattv-hackathon-2026',
    title: 'Tattv Hackathon 2026 — Results & Highlights',
    ...
    content: 'The Tattv Hackathon 2026 was our biggest event yet...',
    author: 'Sneha Reddy',
    authorAvatar: '👩‍🔬',
    date: '2026-01-15',
    category: 'Tattv Capital',
    domain: 'ai-ml',
    readTime: '5 min read',
...
export const BLOG_CATEGORIES = ['All', 'Tattv Capital', 'Tech News', 'Tutorials'];
...
export const EVENTS = [
  ...
  {
    id: 2,
    title: 'Tattv Hackathon 2026 — Spring Edition',
    type: 'Hackathon',
    date: '2026-03-15',
...
export const ANNOUNCEMENTS = [
  {
    id: 1,
    title: 'Welcome to Tattv.AI — Spring 2026!',
...
export const DEMO_USERS = [
  { email: 'dev@tattv.ai', password: 'dev123', role: ROLES.DEV, name: 'System Admin', domain: null },
  { email: 'lead@tattv.ai', password: 'lead123', role: ROLES.LEAD, name: 'Arjun Patel', domain: 'ai-ml' },
  { email: 'mentor@tattv.ai', password: 'mentor123', role: ROLES.MENTOR, name: 'Sneha Reddy', domain: 'ai-ml' },
  { email: 'editor@tattv.ai', password: 'editor123', role: ROLES.EDITOR, name: 'Rohan Verma', domain: null },
  { email: 'member@tattv.ai', password: 'member123', role: ROLES.MEMBER, name: 'Aditya Verma', domain: 'ai-ml' },
  { email: 'faculty@tattv.ai', password: 'faculty123', role: ROLES.FACULTY, name: 'Dr. Anil Kumar', domain: null },
];
