      ...
      <section className="hero">
        ...
        <div className="container hero-content">
          ...
          <h1 className="hero-title animate-fade-in-up delay-1">
            ...
            <span className="text-gradient">Tattva AI</span>
          </h1>
      ...
      <section className="section" id="about">
        <div className="container">
          <div className="section-header">
            ...
            <h2>About <span className="text-gradient">Tattva AI</span></h2>
      ...
      <section className="section" id="team">
        <div className="container">
          <div className="section-header">
            ...
            <p>The leaders and mentors driving Tattva AI forward.</p>
          </div>
      ...
      <section className="section cta-section">
        <div className="container">
          <div className="cta-card">
            ...
            <p>Join Tattva AI and be part of a community that&apos;s shaping the next generation of technology.</p>
